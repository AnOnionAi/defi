...
test.describe('farms page functionality', () => {
    ...
    test('should open the farms page', async ({ page, browserName }) => {
        ...
        await page.screenshot({ path: `tests/screenshots/farms/farms-${browserName}.png`, fullPage: true });
    });

    test('pressing the unlock button and opening metamask modal - farms', async ({ page, browserName }) => {
