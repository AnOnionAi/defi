...
describe('farms page functionality', () => {
	...
	it('pressing the unlock button and opening metamask', async () => {
		...
		await page.screenshot({ path: `screenshots/farms/farms-metamask-${browserName}-close.png`, fullPage: true });
		...
		await overviewPage.screenshot({ path: `screenshots/farms/farms-metamask-${browserName}-open.png`, fullPage: true });
