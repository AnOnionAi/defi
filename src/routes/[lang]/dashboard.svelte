				...
				>
					...
					>
						<div class="pl-4 flex flex items-center">
							...
							<p class="ml-2 text-gray-600 font-bold text-xl dark:text-white">{$_("headers.pools.text")}</p>
						</div>
						<div class="flex flex-col items-center pb-3 gap-2">
							...
							<button class="border border-green-500 rounded-lg py-2 px-5  flex items-center hover:text-white hover:bg-green-400">
								...
								<div class="flex relative">
									...
									<img src="/vaultTokensIcons/dai.svg" alt="daiToken" class="h-5 w-5 absolute left-3" />
								</div>
							</button>
						</div>
					</div>
				...
				>
					...
					>
						<div class="pl-4 flex flex items-center">
							...
							<p class="ml-2 text-gray-600 font-bold text-xl dark:text-white ">{$_("headers.vaults.text")}</p>
						</div>
						<div class="flex flex-col items-center pb-3 gap-2">
							...
							<button class="border border-green-500 rounded-lg py-2 px-5  flex items-center hover:text-white hover:bg-green-400">
								...
								<div class="flex relative">
									...
									<img src="/vaultTokensIcons/usdt.svg" alt="daiToken" class="h-5 w-5 absolute left-3" />
								</div>
							</button>
						</div>
					</div>
