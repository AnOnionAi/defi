...
<section>
        ...
        <div class = "w-11/12 mx-auto">
            <div class = "hover:bg-green-600 hover:cursor-pointer hover:shadow-md my-5 p-5 usdc_mush_g rounded-xl relative">
                ...
                <p class = "absolute shadow-md font-semibold top-0 right-0 p-3 mush-green rounded-tr-xl rounded-bl-xl">QuickSwap</p>
            </div>
            <div class = "hover:bg-green-600 hover:cursor-pointer hover:shadow-md matic_mush_g my-5 p-5 bg-gray-50 rounded-xl relative">
                <span class = "absolute top-0">
            ...
            <div class = "hover:bg-green-600 hover:cursor-pointer hover:shadow-md dyfn_mush_g my-5 p-5 bg-gray-50 rounded-xl relative">
                <span class = "absolute top-0">
                    <img class = "w-15 mt-2" src = {eth}/>
            ...
            <div class = "hover:bg-green-600 hover:cursor-pointer hover:shadow-md sushi_mush_g my-5 p-5 bg-gray-50 rounded-xl relative">
                <span class = "absolute top-0">
