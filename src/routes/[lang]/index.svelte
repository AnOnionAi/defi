        ...
        */
		...
		getMush()
			.then((mush) => {
				...
				scene.add(mushMeshFA, dollarSign, mushMeshLA, floppaMoon, floppaEarth, floppaSun, mushMeshCryp);
			})
			.catch((err) => {
				console.log(err);
			});
...
<section class="relative">
	...
	<section class="text-white mr-auto ml-auto w-5/6">
		<section style="margin-top: 100px;" class="MUSH_about title text-center bg-transparent min-h-screen">
			...
			<h3 class="market-cap relative text-green-500 font-bold text-3xl lg:text-6xl mt-10 lg:mt-20 pt-2 pb-2 max-w-screen -ml-10 -mr-10 lg:ml-auto lg:mr-auto lg:max-w-screen-md m-auto">Market Cap: $10, 000, 000</h3>
		</section>

		<section
			class="MUSH_about shadow-md backdrop-filter max-w-3xl m-auto min-h-screen rounded"
		>
			...
			<div class="MUSH_main_section text-md lg:text-xl">
				<p>
					...
					numquam nostrum blanditiis, dolorum porro laboriosam aut neque modi vel distinctio. Ut, quibusdam
					iste reprehenderit cupiditate voluptatum libero inventore quo quasi earum distinctio in eveniet, 
					rerum consectetur, eligendi sit laudantium minus dicta sapiente possimus quisquam! Veniam vitae 
					quas aspernatur ad veritatis nobis voluptates dolorem cupiditate numquam doloremque, eligendi 
					ratione, quisquam quasi nemo. Nihil quod, enim, tenetur vero quae libero mollitia labore dolorem 
					dolorum necessitatibus quo veniam laboriosam veritatis praesentium aut nulla a ad fuga. Illo optio 
					nostrum eaque quidem! Laborum, voluptate commodi eaque rem dicta tempora animi cumque dolorum
					similique quos exercitationem quam, reiciendis voluptatem odit fugit voluptatum qui tenetur 
					officia harum illo minus magni eligendi? Exercitationem, nulla cumque dolor in ullam explicabo eum.
					Delectus inventore dolore eveniet quam velit deserunt, sunt repellat, possimus unde dignissimos
					laborum tenetur dolor. Iusto consectetur accusantium suscipit neque, ab ut earum accusamus 
					ratione dolores sapiente placeat, quae eveniet adipisci maxime amet? Sequi quia veritatis maiores
					cupiditate minima dicta praesentium quisquam voluptatem dolorem, reprehenderit, in quis 
					perferendis porro temporibus saepe, earum omnis sunt deserunt. Ipsum magni ea corrupti! 
					Expedita ipsa in soluta aspernatur dolorem. Magnam quas nam quasi mollitia a qui aliquam 
					dolore.
				</p>
			</div>
