...
<div
	class="bg-white p-3 dark:bg-neutral-900  rounded-xl w-full h-32 flex flex-col justify-between  dark:text-white shadow-md dark:shadow-none overflow-hidden"
>
