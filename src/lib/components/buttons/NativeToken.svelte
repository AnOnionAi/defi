...
<a href={swapperURL} target="_blank" class="dark:text-white mr-3  px-2 border border-green-500 rounded-md flex items-center bg-white dark:bg-dark-800 font-light">
