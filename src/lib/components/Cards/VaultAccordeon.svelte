...
<div class="my-3">
	<div
		...
		class="border border-gray-300 hover:cursor-pointer shadow-xl {isHidden == false &&
			...
			'rounded-t-lg'} relative hover:bg-gradient-to-t from-{vaultConfig.platform
			...
			{:else}
				<div class="flex flex-col  lg:flex-row flex-wrapper justify-around">
					<div class="lg:w-1/3">
						...
						<div
							class="flex my-2 py-2 px-3 bg-gray-300 dark:bg-dark-500 rounded-lg max-w-sm lg:w-11/12"
						>
							<input
							...
							{#if isApproved}
								<button
									...
									class="flex items-center disabled:opacity-50 disabled:cursor-not-allowed disabled:bg-pink-500 bg-black hover:bg-pink-500 text-white font-bold rounded-lg px-6 py-3 tracking-wide dark:bg-gradient-to-b from-{vaultConfig
					...
					<div class="pt-4 lg:pt-0 lg:w-1/3">
						...
						<div
							class="flex my-2 py-2 px-3 bg-gray-300 rounded-lg max-w-sm dark:bg-dark-500 lg:w-11/12"
						>
							<input
								placeholder="Enter Value"
								class="bg-gray-300 text-gray-900 font-bold w-8/12 dark:bg-dark-500 dark:text-white"
							...
							<button
								...
								class="flex items-center disabled:cursor-not-allowed {loadingState.withdraw &&
									'bg-pink-500'} bg-black hover:bg-{vaultConfig.platform
									.brandColor}-500 text-white font-bold rounded-lg px-6 py-3 tracking-wide dark:bg-gradient-to-b from-{vaultConfig
									.platform.brandColor}-500 to-dark-100"
							>
					...
					<div class="pt-4 lg:pt-0 lg:w-1/3">
						...
						<div
							class="flex items-center my-2 py-2 px-3 bg-gray-300 rounded-lg max-w-sm dark:bg-dark-500 lg:w-10/12"
						>
							...
							<button
								...
								disabled={loadingState.something}
								class="flex items-center bg-black hover:bg-{vaultConfig.platform
									.brandColor}-500 text-white font-bold rounded-lg px-6 py-3 tracking-wide dark:bg-gradient-to-b from-{vaultConfig
									.platform
						...
						<div class="pl-1">
							<p class="text-gray-600 font-semibold pb-1 dark:text-gray-400 font-semibold">
								Current Prices:
							</p>
							<p class="text-gray-800	font-medium dark:text-white ">
								{#if tkn0Price}
