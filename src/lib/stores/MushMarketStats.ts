...
const mushTokenContract = new ethers.Contract(getContractAddress(Token.MUSHTOKEN),ERC20ABI,Provider.getProviderSingleton());
...
export const mushMarketCap = derived([tokenPrice,totalMushSupply],([$tokenPrice,$totalMushSupply]) => {
