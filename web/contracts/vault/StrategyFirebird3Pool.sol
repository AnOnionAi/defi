...
contract StrategyFirebird3Pool is Ownable, ReentrancyGuard, Pausable {
    ...
    address public constant oneswapAddress =
        0x01C9475dBD36e46d1961572C8DE24b74616Bae9e;
    address public constant firebirdFormula =
    ...
    function _farm() internal returns (uint256) {
        ...
        IFirebird(masterchefAddress).depositWithRef(
            pid,
            wantAmt,
            referralAddress
        );
    ...
    function vaultSharesTotal() public view returns (uint256) {
        (uint256 amount, ) = IFirebird(masterchefAddress).userInfo(
            pid,
            address(this)
        );
        return amount;
    ...
    function _resetAllowances() internal {
        ...
        IERC20(usdcAddress).safeIncreaseAllowance(oneswapAddress, uint256(-1));
    ...
    function _safeSwap(
        ...
        uint256[] memory amounts = IFireRouter(firebirdFormula).getAmountsOut(
            _tokenIn,
            _tokenOut,
            _amountIn,
            _path
