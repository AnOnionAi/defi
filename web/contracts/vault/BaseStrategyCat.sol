...
abstract contract BaseStrategyCat is Ownable, ReentrancyGuard, Pausable {
    ...
    function buyBack(uint256 _earnedAmt) internal virtual returns (uint256) {
        if (buyBackRate > 0) {
            ...
            _safeSwap(buyBackAmt, earnedToFishPath, buyBackAddress);
